...
> 本文档是 [`ai-toolkit.toml`](ai-toolkit.toml) profile 的对外发布说明。镜像维护流程见
> [`autodl/skills/ai-toolkit-maintenance/SKILL.md`](../skills/ai-toolkit-maintenance/SKILL.md)
> 与 [`autodl/skills/ai-toolkit-scripts-update/SKILL.md`](../skills/ai-toolkit-scripts-update/SKILL.md)。
...
|---------|----------|------------------|
| 图像生成 | **Z-Image** | 16 GB |
| 图像生成 | Z-Image-De-Turbo | 16 GB |
| 图像生成 | FLUX1 | 16–24 GB |
| 图像生成 | Qwen-Image | 24 GB |
| 图像生成 | SDXL | 8 GB |
| 图像生成 | Qwen-Image-2512 | 24 GB |
| 图像生成 | FLUX.2-klein-4B | 16 GB |
| 图像生成 | FLUX.2-klein-9B | 28 GB |
| 图像生成 | ERNIE-Image | 16 GB |
